...
@implementation ReadRefreshGifHeader
...
//    NSArray *topArray = @[[UIImage imageNamed:@"向上拉1"], [UIImage imageNamed:@"向上拉2"]];
    ...
    [self setImages:bottomArray duration:.1 forState:MJRefreshStateIdle];
    [self setImages:@[[UIImage imageNamed:@"加载1"]] forState:MJRefreshStatePulling];
    
    self.stateLabel.font = [UIFont systemFontOfSize:14];
    [self setTitle:@"松开阅读上一篇题目" forState:MJRefreshStatePulling];
    [self setTitle:@"下拉作答上一篇阅读" forState:MJRefreshStateIdle];
